...
use xenialdan\PocketAI\component\minecraft\_identifier;
use xenialdan\PocketAI\component\minecraft\behavior\_follow_parent;
...
class Loader extends PluginBase
{
    ...
    private function debug()
    {
        try {
            ...
            $this->getLogger()->debug(print_r($entityProperties->findComponents(_identifier::class), true));
            $this->getLogger()->debug(">==========< findComponents more than 1 entry >==========<");
            $this->getLogger()->debug(print_r($entityProperties->findComponents(_follow_parent::class), true));
