...
class EntityProperties
{
    ...
    public function __construct(string $behaviour, $entity)
    {
        ...
        if (!array_key_exists($behaviour, Loader::$behaviour)) throw new \InvalidArgumentException("Entity behaviour/properties file: " . $behaviour . " not found for entity of type " . $entity->getName());
